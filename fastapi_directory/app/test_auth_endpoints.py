...
auth_url = "http://localhost:8090/api/auth/users/me"
auth_headers = {
...
auth_basic_url = "http://localhost:8090/api/auth/users/me/basic"
auth_basic_headers = {
    "Authorization": f"Bearer {token}"
}
...
# Test the users endpoint through nginx (this should fail)
users_url = "http://localhost:8090/api/users/me"
users_headers = {
    "Authorization": f"Bearer {token}"
}

print("\nTesting users endpoint through nginx (should fail)...")
try:
